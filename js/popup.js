...
$(document).ready(function () {
    ...
    // $(document).ready(function () {
        ...
        // if(selectAudio){
        //     selectAudio.addEventListener('click', swapper, false, (event) =>{
        ...
        // function  clickAudio ()  {
        //     document.getElementById("onlyaudio").value = "micro";
        //   };
        ...
        function showselected() {
            // $('#mic-label2').show(); 
            // $('#audiorecording').show(); 
            // $(".tabAudio").click(function(){
            //     tabaudiodiv.style.display = 'none';
            //     $("#timeRem").hide();

            // });

            // if ($(".tabAudio").click(function(){
            //     $('#mic-label2').show(); 
            //     $('#audiorecording').show(); 
            //     tabaudiodiv.style.display = 'none';
            //     $("#timeRem").hide();
            ...
            if ($('#hidevideotab').change(function(){
                ...
                } else if($('#onlyaudio').val() == 'tabaudio') {
                    $('#start').show() ; 
                $('#mic-label2').hide(); 
